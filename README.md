...
| Назва | Опис |
|------|------|
| Grizzle | Фріланс-проєкт. Створений мною в Figma. Багатосторінковий адаптивний сайт, використовується HTML, CSS та JavaScript, без бібліотек. Адаптивна верстка.|
